...
from minicasp.utils.paths import data_path
from minicasp.utils.type_utils import Optional
...
def logger() -> logging.Logger:
    ...
    """
    return logging.getLogger("minicasp")
...
def setup_logger(
    ...
    if file_level:
        ...
        config["loggers"]["minicasp"]["handlers"].remove("file")
