...
from minicasp.scoring.scorers_base import Scorer, make_rxnutils_route
...
if TYPE_CHECKING:
    ...
    from minicasp.utils.type_utils import Optional, Sequence, StrDict, TypeVar
    ...
    def __init__(
        ...
        if not SUPPORT_DISTANCES:
            raise ValueError(
                ...
                " Please install minicasp with extras dependencies."
            )
