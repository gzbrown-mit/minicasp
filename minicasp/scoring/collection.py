...
from minicasp.stock.collection import ContextCollection
from minicasp.scoring.scorers import StateScorer
from minicasp.scoring.scorers import __name__ as scorers_module
...
from minicasp.reactiontree import ReactionTree
from minicasp.search import MctsNode
...
if TYPE_CHECKING:
    ...
    from minicasp.utils.type_utils import Any, List, Sequence, TypeVar, Union
...
class ScorerCollection(ContextCollection):
    """
    Store scorer objects for the minicasp interface.
    ...
    def load_from_config(self, **scorers_config: Any) -> None:
        ...
        defined in the ``minicasp.scoring`` module, the module
