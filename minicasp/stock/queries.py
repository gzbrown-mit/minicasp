...
from minicasp.chem import Molecule
from minicasp.utils.exceptions import StockException
from minicasp.utils.mongo import get_mongo_client
from minicasp.utils.paths import resolve_data_file

if TYPE_CHECKING:
    from pymongo.collection import Collection as MongoCollection
    from pymongo.database import Database as MongoDatabase

    from minicasp.utils.type_utils import Optional, Set, StrDict
...
class InMemoryInchiKeyQuery(StockQueryMixin):
    ...
    def __init__(
        ...
        # Allow old repo-root or bare filenames by resolving against bundled data.
        path = resolve_data_file(path, subdir_hint="buyables")
